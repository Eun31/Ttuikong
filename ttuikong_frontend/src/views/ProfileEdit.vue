  ...
  export default {
    ...
    data() {
      return {
        ...
        profileImage: null, // 사용자가 업로드한 새 이미지
        isSubmitting: false,
        userProfile: {
          id: 1,
          nickname: '러닝마니아',
          description: '신나는 강아지', // 한줄 소개
          age: 28,
          gender: '남성',
          height: 175.0,
          weight: 68.5,
    ...
    methods: {
      ...
      selectActivity(activityValue) {
        this.userProfile.activityGoal = activityValue;
      },
      saveProfile() {
        this.isSubmitting = true;
        
        // 여기에 API 호출 코드가 들어갈 수 있습니다.
        // 예: this.$api.updateProfile(this.userProfile, this.profileImage)
