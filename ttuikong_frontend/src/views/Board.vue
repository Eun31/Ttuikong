...
<template>
  <div class="board-container">
    ...
    <div class="category-filter">
      ...
      <button class="category-btn" :class="{ active: currentCategory === 'daily' }" @click="filterByCategory('daily')">일상</button>
      <button class="category-btn" :class="{ active: currentCategory === 'food' }" @click="filterByCategory('food')">맛집</button>
      <button class="category-btn" :class="{ active: currentCategory === 'travel' }" @click="filterByCategory('travel')">여행</button>
      <button class="category-btn" :class="{ active: currentCategory === 'tech' }" @click="filterByCategory('tech')">기술</button>
      <button class="category-btn" :class="{ active: currentCategory === 'music' }" @click="filterByCategory('music')">음악</button>
    </div>
